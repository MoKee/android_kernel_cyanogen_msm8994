...
#define FM_BLEND_RSSI_STEREO_THRESHOLD_PROP 0x1800
#define FM_BLEND_RSSI_MONO_THRESHOLD_PROP 0x1801
#define FM_SOFT_MUTE_MAX_ATTENUATION_PROP 0x1302
#define FM_SOFT_MUTE_SNR_THRESHOLD_PROP 0x1303
#define RX_VOLUME_PROP 0x4000
