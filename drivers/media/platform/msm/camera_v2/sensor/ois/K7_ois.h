...
//#define	CATCHMODE               // Catch mode
  ...
  #define	G_45G_INI_IDG2030	0x3E3FECFF	// 32.8/175 = 0.187428571 = -14.543[dB]	//IDG-2030 FS_SEL=2
  #define	G_45G_INI_IDG2021	0x3F003208	// 32.8/65.5 = 0.500763359 = -6[dB]		//IDG-2021 FS_SEL=2
#endif	//CATCHMODE
...
// EEPROM Address Define	1800_1840
#define		E2POFST				0x1800
/****************** page ******************/
...
// Hall Adjust
#define		HALL_BIAS_X				(0x000B + E2POFST)		// X Hall Bias
#define		HALL_BIAS_Y				(0x000D + E2POFST)		// Y Hall Bias
/****************** page ******************/
#define		HALL_OFFSET_X			(0x000F + E2POFST)		// X Hall Offset
#define		HALL_OFFSET_Y			(0x0011 + E2POFST)		// Y Hall Offset
// Loop Gain Adjust
#define		LOOP_GAIN_X				(0x0013 + E2POFST)		// X Loop Gain
#define		LOOP_GAIN_Y				(0x0015 + E2POFST)		// Y Loop Gain
// LENS CENTER FINAL
#define		LENS_CENTER_FINAL_X		(0x0017 + E2POFST)		// X Lens Center
#define		LENS_CENTER_FINAL_Y		(0x0019 + E2POFST)		// Y Lens Center
// Gyro A/D Offset
#define		GYRO_AD_OFFSET_X		(0x001B + E2POFST)		// X Gyro Offset
#define		GYRO_AD_OFFSET_Y		(0x001D + E2POFST)		// Y Gyro Offset
/****************** page ******************/
// OSC VALUE
#define		OSC_CLK_VAL				(0x001F + E2POFST)		// Oscillator Cal. value 1byte Setting
// Adjustment Completion Flag
#define		ADJ_HALL_FLAG			(0x0020 + E2POFST)		// XY Cal. Flag
#define		ADJ_GYRO_FLAG			(0x0022 + E2POFST)		// XY Gyro Cal. Flag
#define		ADJ_LENS_FLAG			(0x0024 + E2POFST)		// XY Lens Center Cal. Flag
// Gyro GAIN 
#define		GYRO_GAIN_X				(0x0026 + E2POFST)		// 4byte Setting
#define		GYRO_GAIN_Y				(0x002A + E2POFST)		// 4byte Setting
#define		LIMIT_CAL_X				(0x002E + E2POFST)		// 4byte Setting
/****************** page ******************/
#define		LIMIT_CAL_Y				(0x0032 + E2POFST)		// 4byte Setting
// F/W Version Information
#define		FW_VERSION_INFO			(0x0036 + E2POFST)		// FW Version
/////////////////////////////////////////////////////////////////////////////
#define		MSB_CHKSUM				(0x0038 + E2POFST)		// 1byte Setting
#define     LSB_CHKSUM				(0x0039 + E2POFST)		// 1byte Setting
...
/* OIS Calibration Parameter */
 #define	DAHLXO_INI		0x0100		// Hall X Offset
 #define	DAHLXB_INI		0xEA00		// Hall X Bias
 #define	DAHLYO_INI		0xFF00		// Hall Y Offset
...
#ifdef	CATCHMODE
 #define	GXGAIN_INI		0xBE75C202	// Gyro X Zoom Value	+0.24
 #define	GYGAIN_INI		0xBE75C202	// Gyro Y Zoom Value	+0.24
#else	//CATCHMODE
 #define	GXGAIN_INI		0xBE99999A	// Gyro X Zoom Value
 #define	GYGAIN_INI		0xBE99999A	// Gyro Y Zoom Value
#endif	//CATCHMODE

/* AF Calibration Parameter */
#define		DAHLZB_INI		0xEF00		// Hall Z Bias
#define		DAHLZO_INI		0x7800		// Hall Z Offset
#define		AFOFF4Z_INI		0x0000		// Hall Z AD Offset
...
/* Actuator Select MTM */
#define		BIAS_CUR_OIS_MTM	0x33	// 2.0mA	//MTM  5th Act.
#define		AMP_GAIN_X_MTM		0x03	// x75		//MTM  5th Act.
#define		AMP_GAIN_Y_MTM		0x03	// x75		//MTM  5th Act.

/* AF adjust parameter MTM */
#define		BIAS_CUR_AF_MTM		0x04	//3.0mA		//MTM  5th Act.
#define		AMP_GAIN_AF_MTM		0x04	//x100		//MTM  5th Act.

#define		SXQ_INI_MTM			0x3F800000
#define		SYQ_INI_MTM			0x3F800000


/* Actuator Select LGIT */
#define		BIAS_CUR_OIS_LGIT	0x33	// 2.0mA	//LGIT 5th Act.
#define		AMP_GAIN_X_LGIT		0x03	// x75		//LGIT 5th Act.
#define		AMP_GAIN_Y_LGIT		0x03	// x75		//LGIT 5th Act.

/* AF adjust parameter LGIT*/
#define		BIAS_CUR_AF_LGIT	0x01	//0.5mA		//LGIT 5th Act.
#define		AMP_GAIN_AF_LGIT	0x04	//x100		//LGIT 5th Act.
...
#ifdef	CATCHMODE
//#define	FS_SEL		2		/*  */
#define	FS_SEL		2			/* 175LSB  /DPS : IDG2030 , 65.5LSB /DPS : IDG2021 */
#else	//CATCHMODE
/* Select Gyro Sensor */
//#define	FS_SEL		0		/* 700LSB  /DPS : IDG2030 , 262LSB  /DPS : IDG2021 */
//#define	FS_SEL		1		/* 350LSB  /DPS : IDG2030 , 131LSB  /DPS : IDG2021 */
#define		FS_SEL		2		/* 175LSB  /DPS : IDG2030 , 65.5LSB /DPS : IDG2021 */
//#define	FS_SEL		3		/* 87.5LSB /DPS : IDG2030 , 32.8LSB /DPS : IDG2021 */
#endif	//CATCHMODE
...
// #define		GYRLMT3_S2_W	0x3F0CCCCD		//0.55F
 #define		GYRLMT3_S1_W	0x3EE66666		//0.45F
 #define		GYRLMT3_S2_W	0x3EE66666		//0.45F
 ...
 //#define		GYRLMT4_S1		0x40F2D594 	// 7.589F  pm 2.0[deg]
 //#define		GYRLMT4_S2		0x40F2D594 	// 7.589F  pm 2.0[deg]
 #define		GYRLMT4_S1		0x41058F12 	// 8.347F  pm 2.2[deg]
 #define		GYRLMT4_S2		0x41058F12 	// 8.347F  pm 2.2[deg]
 
 //#define		GYRA12_HGH		0x40DA8D05	// 6.830F  pm 1.80[deg]
...
typedef struct STCALDAT {
	...
	struct {
		...
		unsigned short	UsLzgVal ;				// Loop Gain Z
	} StLopGan ;
	...
	unsigned short		UsAdjHallZF ;			// Adjustment Completion Flag
...
struct STSETVAL {
	unsigned char	UcSetMod ;
	unsigned short	UsRamAdd ;
	unsigned long	UlRamDat ;
} ;													// Filter Coefficient Table

typedef	struct	STSETVAL	_STSETVAL;
...
union	RM2VAL {
	unsigned long	UlLngVal;
	struct {
		unsigned short	UsHalVal ;
		unsigned short	UsDrvVal ;
	}StRamVal;
} ;

typedef union RM2VAL	UnRm2Val ;
...
K7_OISINI__ void	AfVcmCodCnv( unsigned short);				// AF code converting and setting
K7_OISINI__ void	AfVcmCod( signed short );						// AF Code Write
K7_OISINI__ void	IniClAf( void ) ;								// Closed AF Initial Setting
K7_OISINI__	void	SetDOFSTDAF( unsigned char );					// 
K7_OISINI__ void	SrvConAF( unsigned char ) ;						// AF Servo ON/OFF
K7_OISINI__ void	AfSrvOnOffset( void ) ;
K7_OISINI__ void	AfSrvCurPos( void ) ;
K7_OISINI__ void	StmvSetClAf( void );
K7_OISINI__ void	StmvExeClAf( unsigned short );
K7_OISINI__ void	StmvFinClAf( void );
K7_OISINI__ void	PwmCareerSet( unsigned char );
...
K7_OISINI__ void	CtrStandby( unsigned char ) ;				// Standby control ( Servo OIS control )
